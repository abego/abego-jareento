...
//                }
        ...
        public void onInstruction(String className, String methodName, String parameters, String returnType, int offset, String mnemonic, String arguments, String comment) {
            if (mnemonic.startsWith("invoke")) {
                ...
                String callingMethodReturnType = JavaLangUtil.rawName(returnType);
    ...
    private static void dumpSortedToFile(List<String> strings, String fileName) {
    ...
    private InputFromJavap(File file, File[] jarFiles, Consumer<String> progress, JavaAnalysisAPI javaAnalysisAPI) {
        this.file = file;
    ...
    private static List<String> getDeclaredClasses(JavaAnalysisProject project) {
        return project.classes().stream()
                .filter(c -> !isUndeclared(c, project))
                .map(WithId::id)
                .collect(Collectors.toList());
